...
const GenRollupConfig = (usedMemory, context) => {
    return new Promise(resolve => {
        parseRender_1.default(path_1.default.resolve(__dirname, '../../../../../assets/rollup.config.js'), path_1.default.resolve(context.targetPath, './rollup.config2.js'), usedMemory, () => {
