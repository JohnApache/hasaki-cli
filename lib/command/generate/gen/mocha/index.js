...
const GenMochaConfig = (usedMemory, context) => {
    return new Promise(resolve => {
        const useTs = usedMemory['typescript'];
        parseRender_1.default(path_1.default.resolve(__dirname, '../../../../../assets/mocha-demo.js'), path_1.default.resolve(context.targetPath, `mocha-demo.${useTs ? 'ts' : 'js'}`), usedMemory, () => {
