...
const BuildESLintPackageInfo = (usedMemory) => {
    ...
    if (!useReact && useTs) {
        packageInfo = lodash_1.default.merge(packageInfo, { devDependencies: { '@dking/eslint-config-typescript': '^0.0.4' } });
    }
    if (useReact && useTs) {
        packageInfo = lodash_1.default.merge(packageInfo, { devDependencies: { '@dking/eslint-config-typescript-react': '^0.0.3' } });
    }
    return packageInfo;
};
