...
const GenWebpackConfig = (usedMemory, context) => __awaiter(void 0, void 0, void 0, function* () {
    return new Promise(resolve => {
        ...
        const contextPath = path_1.default.resolve(context.targetPath, './webpack_config2');
