...
const beforeInit_1 = require("../init/beforeInit");
const download_1 = require("../init/download");
const repoPipe_1 = require("../init/repoPipe");
...
const InstallAction = (remoteAddress, command) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield download_1.DownloadHandle(remoteAddress, tmpRepoPath, options);
