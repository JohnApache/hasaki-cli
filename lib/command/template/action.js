...
const template_2 = require("../../common/template");
const prompt_1 = require("./prompt");
const ListAction = () => __awaiter(void 0, void 0, void 0, function* () {
    const templates = yield template_1.GetTemplates();
