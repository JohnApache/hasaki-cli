...
const CreateScreener = (rootPath, screenRule) => {
    ...
    const IsInclude = (targetPath) => {
        return analyse_1.IsMatchRules(rootPath, targetPath, include);
    };
    const IsExclude = (targetPath) => {
        return analyse_1.IsMatchRules(rootPath, targetPath, exclude);
    };
