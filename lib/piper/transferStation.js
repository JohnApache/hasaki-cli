...
const CreateTransferStation = (rootPath, transferRule) => {
    ...
    const IsParseExclude = (targetPath) => analyse_1.IsMatchRules(rootPath, targetPath, AllParseExclude);
    const IsParseInclde = (targetPath) => analyse_1.IsMatchRules(rootPath, targetPath, AllParseInclude);
