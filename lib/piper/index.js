...
exports.FileCleanner = (...cleanItem) => new Promise((resolve, reject) => {
    try {
...
exports.FilePiper = (source, target, parseOption) => new Promise((resolve, reject) => {
    ...
    const TransferStation = transferStation_1.default(source, {
        parseExclude,
        parseInclude,
    });
